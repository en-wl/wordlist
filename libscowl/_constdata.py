...
posInfo = {
  ...
  'vds': PosInfo(order_num=12, name='vds', base_pos='v', descr='verb: past tense plural (were)', note=None, extra_info=None),
  ...
  'vss': PosInfo(order_num=18, name='vss', base_pos='v', descr='verb: present tense plural (are)', note=None, extra_info=None),
